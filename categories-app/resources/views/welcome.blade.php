...
<body class="antialiased">
    <div class="h-100 d-flex flex-column align-items-center justify-content-center m-3">
        @include('sessions')
        <img src="paytabslogo.png" alt="" class="m-3">
        <form class="row mt-3" action="{{ route('categories.store') }}" method="POST">
            @csrf
            ...
            @if (!$categories->isEmpty())
                <div class="col-12 mb-3">
                    <input class="form-check-input" type="checkbox" value="" onchange="ActiveSub()" id="flexCheckChecked"
                        checked>
                ...
                {{-- <div class="col-12 mb-3">
                    <select class="form-select mb-3" name="parent_id" id="subcategory" disabled>
                        <option>Please choose sub category</option>
                    </select>
...
<script type="text/javascript">
    ...
    function omarr(e) {
        ...
        $.ajax({
            ...
            error: function() {
                var newSub = document.getElementById("subcategory");
